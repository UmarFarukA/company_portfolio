                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin_home_slider') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 ">
                                        <img id="showImage" src="{{(!empty($homeData->home_img) ? url('/uploads/About_images/'.$homeData->home_img) : url('/uploads/no_image.png')) }} " class="rounded avatar-lg"  alt="Home Image">
                                    </div>
                                </div>
                                {{-- End field --}}

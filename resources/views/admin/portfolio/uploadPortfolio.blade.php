                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('store.portfolio') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 ">
                                        <img id="showImage" src="{{(!empty($portfolio->image) ? url('/uploads/About_images/'.$portfolio->image) : url('/uploads/no_image.png')) }} " class="rounded avatar-lg"  alt="Home Image">
                                    </div>
                                </div>
                                {{-- End field --}}

                                <div class="row mb-3">
                                    <input type="submit" value="Submit" class="col-sm-2 btn btn-info waves-light">

@php
    $home = App\Models\HomeSlide::find(1);
@endphp

{{-- I will give you Best</span> <br> Product in the shortest time.<span> --}}
{{-- I'm a Rasalina based product design & visual designer focused on crafting clean & user‑friendly experiences --}}
        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h2 class="title wow fadeInUp" data-wow-delay=".2s">{{ $home->title }}</h2>
